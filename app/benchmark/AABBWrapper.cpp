...
void fastEnvelope::AABBWrapper::init_b_mesh(
...
// void fastEnvelope::AABBWrapper::init_tmp_b_mesh_and_tree(const Mesh& mesh, const
// std::vector<std::array<int, 2>>& b_edges){
//     if (b_edges.empty()) {
...
void fastEnvelope::AABBWrapper::init_tmp_b_mesh_and_tree(
    const std::vector<Vector3>& input_vertices,
    const std::vector<Vector3i>& input_faces,
