...
function(fast_envelope_get_dependencies_recursive OUTPUT_VARIABLE TARGET)
    ...
    foreach(DEPENDENCY IN ITEMS ${TARGET_DEPENDENCIES})
        if(TARGET ${DEPENDENCY})
            ...
            if(NOT (DEPENDENCY IN_LIST VISITED_TARGETS))
                ...
                fast_envelope_get_dependencies_recursive(VISITED_TARGETS ${DEPENDENCY})
            endif()
        endif()
    endforeach()
...
function(fast_envelope_get_dependencies OUTPUT_VARIABLE TARGET)
    set(DISCOVERED_TARGETS "")
    fast_envelope_get_dependencies_recursive(DISCOVERED_TARGETS ${TARGET})
...
# folder.
function(fast_envelope_copy_dll target)
    if(NOT WIN32)
        return()
    endif()
    ...
    if(NOT ${TYPE} STREQUAL "EXECUTABLE")
        message(FATAL_ERROR "fast_envelope_copy_dll() was called on a non-executable target: ${target}")
    endif()
    ...
    fast_envelope_get_dependencies(TARGET_DEPENDENCIES ${target})
